...
Sequence.prototype._setMethods = function () {
    ...
    //vighneshDandekar decrementByone
    this._schema.static('decrementByOneCounter', function (id, reference, callback) {
        var sequence = sequenceArchive.getSequence(id);
        sequence._counterDecrementByOne(id, reference, callback);
    }.bind(this));
};
...
// vighneshdandekar decrementByone function
Sequence.prototype._counterDecrementByOne = function (id, reference, callback) {
    var condition = { id: id };
    if (reference instanceof Function) {
        callback = reference;
    } else {
